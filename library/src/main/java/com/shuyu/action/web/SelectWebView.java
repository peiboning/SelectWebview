...
/**
 * Created by peiboning on 2017/6/29.
 */
...
public class SelectWebView extends WebView {
    ...
    public SelectWebView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public SelectWebView(Context context, AttributeSet attrs, int defStyleAttr) {
     ...
     */
    public void setActionSelectListener(SelectListener selectListener) {
    ...
    private class ActionSelectInterface {
        ...
        SelectWebView mContext;

        ActionSelectInterface(SelectWebView c) {
            mContext = c;
        }
        ...
        public void callback(final String value, final String title) {
            if(mSelectListener != null) {
                mSelectListener.onClick(title, value);
            }
        }
    }
}
